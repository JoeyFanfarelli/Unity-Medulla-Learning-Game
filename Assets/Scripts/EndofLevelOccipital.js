...
function OnTriggerEnter (other: Collider) {
	...
	if (other.tag=="Player"){
		...
		AchievementWatcher.BeatLevelTwo = true;
		AchievementWatcher.CurrentAchievementText = "Savior of Occipital";
		AchievementWatcher.notify = true;
		Debug.Log("AchievementWatcher.notify set to true");
		...
		Debug.Log("Score: " + PlayerHealth.score);
		Debug.Log("Total Score: " + PlayerHealth.totalScore);
		...
		Application.LoadLevel("LevelThree2D");
