...
function OnMouseDown(){
	...
	if (CureType == pHealth.IllType){ //If the correct button is clicked, button matches illness
		...
		if (AchievementWatcher.CureOptionalZone == true && AchievementWatcher.CureOptional == false){
			AchievementWatcher.CureOptional = true;
			AchievementWatcher.CurrentAchievementText = "Heroic";
			AchievementWatcher.notify = true;
		}
...
//Returns nearest object with a particular tag ("citizen")
