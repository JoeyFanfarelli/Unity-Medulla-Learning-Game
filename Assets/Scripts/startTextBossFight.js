...
function OnTriggerEnter (other: Collider) {
	...
	if (other.tag=="Player"){
		if (PlayerHealth.startMotorChatProg == 0){
			...
			PlayerHealth.startBossFightStartDialogue=true;
			...
			textMesh.text = "This is it. He’s just down the road. Don’t worry. I will stand by you and fight!";
			tw.updateText();
		}
	}
...
function Update () {
	...
	if (Input.GetButtonDown("Space")){
		if (PlayerHealth.startBossFightStartDialogue==true){
			if(PlayerHealth.startMotorChatProg ==0){
				PlayerHealth.startMotorChatProg =1;
				textMesh.text = "There are a few more citizens who need your help. Cure them and we may gain more allies.";
				tw.updateText();
				...
				PlayerHealth.startBossFightStartDialogue=false;
			}
