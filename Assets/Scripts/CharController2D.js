...
public static var runSpeed:float=12.0;
private var jumpSpeed:float=speed*1.7;
public static var gravity:float=60.0;
...
function FixedUpdate(){
	if (Input.GetKey("a")){
		...
		if (Input.GetKey("d") && AchievementWatcher.MoonWalker == false){
			AchievementWatcher.MoonWalker = true;
			AchievementWatcher.CurrentAchievementText = "Moonwalker";
